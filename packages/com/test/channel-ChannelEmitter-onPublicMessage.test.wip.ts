...
it("ignores event not coming from target", async (t) => {
...
it("doens't throw on invalid message received", async (t) => {
	const channelEmitter = new StandaloneEmitterEmitter(iframe, {});
...
it("accepts ready requests", async (t) => {
	const channelEmitter = new StandaloneEmitterEmitter(iframe, {});
...
it("accepts ready requests and call `receiverReadyCallback` when available", async (t) => {
	const channelEmitter = new StandaloneEmitterEmitter(iframe, {});
	// @ts-expect-error - taking a shortcut by accessing private property
...
it("rejects non-ready requests", async (t) => {
	const channelEmitter = new StandaloneEmitterEmitter(iframe, {});
	// @ts-expect-error - taking a shortcut by accessing protected property
...
it("ignores response messages", async (t) => {
	const channelEmitter = new StandaloneEmitterEmitter(iframe, {});
	// @ts-expect-error - taking a shortcut by accessing protected property
