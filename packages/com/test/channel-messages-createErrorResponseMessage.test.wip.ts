...
it("creates a valid error response message with default status", (t) => {
...
it("creates a valid error response message with status", (t) => {
...
it("throws when invalid error status is provided", (t) => {
