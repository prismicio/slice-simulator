...
it("throws when accessing unset port", (t) => {
...
it("listens to new port messages automatically", async (t) => {
	const channelNetwork = new StandaloneChannelNetwork({}, {});
...
it("stops listening to old port after new port automatically", async (t) => {
	const channelNetwork = new StandaloneChannelNetwork({}, {});
	const spiedChannelNetwork = sinon.spy(channelNetwork);
