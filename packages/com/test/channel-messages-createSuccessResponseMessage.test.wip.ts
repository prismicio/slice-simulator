...
it("creates a valid success response message with default status", (t) => {
...
it("creates a valid success response message with status", (t) => {
...
it("throws when invalid success status is provided", (t) => {
